    ...
    return (
        <Layout>
            ...
            <Container maxWidth='xl'>
                {/* <Box component='div' id='heroImg'>
                    <Typography variant='h1'>3D Visualisation</Typography>
                    <Typography variant='body1'>
                        Showcase your products, designs, and ideas in beautiful, photorealistic 3D interior settings. Interior
                        CGIs are an incredible way to achieve photorealistic imagery that can be constantly updated to fit with
                        new launches or a rebrand of your business, all at the fraction of the cost of traditional photoshoots.
                    </Typography>
                </Box> */}
                <Box component={"div"} className='serviceItem'>
                    ...
                    <Box component={"div"} className='serviceDescription'>
                        ...
                        <br />
                        <Typography sx={{ pr: "4rem", fontSize: "1.5rem" }}>
